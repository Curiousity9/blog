...
public class TagController {
    ...
    public String post(@Valid Tag tag,
        ...
        if(tag1 != null){
            result.rejectValue("name","nameError","已有该标签,不能重复添加!");
        }
        if(result.hasErrors()){
            return "admin/tags-input";
        }
        ...
        if(t == null){
            ...
            attributes.addFlashAttribute("message","标签新建成功o(*￣▽￣*)ブ");
        }
        return "redirect:/admin/tags";
    }

    @PostMapping("/tags/{id}")
    public String delete(@Valid Tag tag,
        ...
        if(t==null){
            attributes.addFlashAttribute("message","标签跟新失败(；′⌒`)");
        }else {
            attributes.addFlashAttribute("message","标签跟新成功o(*￣▽￣*)ブ");
        }
        return "redirect:/admin/tags";
    }
    ...
    public String delete(@PathVariable Long id,
        ...
        attributes.addFlashAttribute("message","标签删除成功o(*￣▽￣*)ブ");
        return "redirect:/admin/tags";
    }
